...
pub fn enforce_dup(result: &mut [u128], old_stack: &[u128], new_stack: &[u128], op_flag: u128) {
...
pub fn enforce_dup2(result: &mut [u128], old_stack: &[u128], new_stack: &[u128], op_flag: u128) {
    result.agg_constraint(0, op_flag, are_equal(new_stack[0], old_stack[0]));
...
pub fn enforce_dup4(result: &mut [u128], old_stack: &[u128], new_stack: &[u128], op_flag: u128) {
    result.agg_constraint(0, op_flag, are_equal(new_stack[0], old_stack[0]));
    result.agg_constraint(1, op_flag, are_equal(new_stack[1], old_stack[1]));
...
/// of the stack; the old stack is shifted right by 2 element.
pub fn enforce_pad2(result: &mut [u128], old_stack: &[u128], new_stack: &[u128], op_flag: u128) {
...
pub fn enforce_drop(result: &mut [u128], old_stack: &[u128], new_stack: &[u128], op_flag: u128) {
...
pub fn enforce_drop4(result: &mut [u128], old_stack: &[u128], new_stack: &[u128], op_flag: u128) {
...
pub fn enforce_swap(result: &mut [u128], old_stack: &[u128], new_stack: &[u128], op_flag: u128) {
...
/// of the stack; the rest of the stack is unaffected.
pub fn enforce_swap2(result: &mut [u128], old_stack: &[u128], new_stack: &[u128], op_flag: u128) {
...
/// of the stack; the rest of the stack is unaffected.
pub fn enforce_swap4(result: &mut [u128], old_stack: &[u128], new_stack: &[u128], op_flag: u128) {
...
/// of the stack; the rest of the stack is unaffected.
pub fn enforce_roll4(result: &mut [u128], old_stack: &[u128], new_stack: &[u128], op_flag: u128) {
...
/// of the stack; the rest of the stack is unaffected.
pub fn enforce_roll8(result: &mut [u128], old_stack: &[u128], new_stack: &[u128], op_flag: u128) {
